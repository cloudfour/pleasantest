const roles = {
  ...
  combobox: {
    ...
    requiredContextRole: [],
    requiredOwnedElements: [],
    requiredProps: ['aria-controls', ['aria-expanded', 'false']],
    superClass: ['input'],
  },
  command: {
    abstract: true,
  ...
  menuitemradio: {
    ...
    requiredOwnedElements: [],
    requiredProps: ['aria-checked'],
    superClass: ['menuitemcheckbox', 'radio'],
  },
  meter: {
    abstract: false,
    accessibleNameRequired: true,
  ...
  scrollbar: {
    ...
    requiredContextRole: [],
    requiredOwnedElements: [],
    requiredProps: ['aria-controls', 'aria-valuenow'],
    superClass: ['range', 'widget'],
  },
  search: {
    abstract: false,
...
console.log(
  Object.entries(roles)
    .filter(([name, value]) => value.childrenPresentational)
    .map(([name]) => name),
);
